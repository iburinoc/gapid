...
func (ω *EglCreateContext) Mutate(ctx context.Context, id api.CmdID, s *api.GlobalState, b *builder.Builder, m api.Manager) error {
...
func (ω *EglMakeCurrent) Mutate(ctx context.Context, id api.CmdID, s *api.GlobalState, b *builder.Builder, m api.Manager) error {
	...
	if err := cb.ReplayBindRenderer(ctxID).Mutate(ctx, id, s, b, nil); err != nil {
		return err
	}
...
func (ω *WglCreateContext) Mutate(ctx context.Context, id api.CmdID, s *api.GlobalState, b *builder.Builder, m api.Manager) error {
	err := ω.mutate(ctx, id, s, nil, nil)
	if b == nil || err != nil {
		return err
	}
...
func (ω *WglCreateContextAttribsARB) Mutate(ctx context.Context, id api.CmdID, s *api.GlobalState, b *builder.Builder, m api.Manager) error {
	err := ω.mutate(ctx, id, s, nil, nil)
	if b == nil || err != nil {
		return err
	}
...
func (ω *WglMakeCurrent) Mutate(ctx context.Context, id api.CmdID, s *api.GlobalState, b *builder.Builder, m api.Manager) error {
	err := ω.mutate(ctx, id, s, nil, nil)
	if b == nil || err != nil {
		return err
	}
	...
	cb := CommandBuilder{Thread: ω.Thread(), Arena: s.Arena}
	return cb.ReplayBindRenderer(ctxID).Mutate(ctx, id, s, b, nil)
}

func (ω *CGLCreateContext) Mutate(ctx context.Context, id api.CmdID, s *api.GlobalState, b *builder.Builder, m api.Manager) error {
	err := ω.mutate(ctx, id, s, nil, nil)
	if b == nil || err != nil {
		return err
	}
...
func (ω *CGLSetCurrentContext) Mutate(ctx context.Context, id api.CmdID, s *api.GlobalState, b *builder.Builder, m api.Manager) error {
	err := ω.mutate(ctx, id, s, nil, nil)
	if b == nil || err != nil {
		return err
	}
...
func (ω *GlXCreateContext) Mutate(ctx context.Context, id api.CmdID, s *api.GlobalState, b *builder.Builder, m api.Manager) error {
	err := ω.mutate(ctx, id, s, nil, nil)
	if b == nil || err != nil {
		return err
	}
...
func (ω *GlXCreateNewContext) Mutate(ctx context.Context, id api.CmdID, s *api.GlobalState, b *builder.Builder, m api.Manager) error {
	err := ω.mutate(ctx, id, s, nil, nil)
	if b == nil || err != nil {
		return err
	}
...
func (ω *GlXMakeContextCurrent) Mutate(ctx context.Context, id api.CmdID, s *api.GlobalState, b *builder.Builder, m api.Manager) error {
	err := ω.mutate(ctx, id, s, nil, nil)
	if b == nil || err != nil {
		return err
	}
...
func (cmd *GlProgramBinaryOES) Mutate(ctx context.Context, id api.CmdID, s *api.GlobalState, b *builder.Builder, m api.Manager) error {
...
func (cmd *GlLinkProgram) Mutate(ctx context.Context, id api.CmdID, s *api.GlobalState, b *builder.Builder, m api.Manager) error {
	if err := bindAttribLocations(ctx, cmd, id, s, b, cmd.Program()); err != nil {
		return err
	}
	if err := cmd.mutate(ctx, id, s, b, nil); err != nil {
...
func (cmd *GlProgramBinary) Mutate(ctx context.Context, id api.CmdID, s *api.GlobalState, b *builder.Builder, m api.Manager) error {
	if err := bindAttribLocations(ctx, cmd, id, s, b, cmd.Program()); err != nil {
		return err
	}
	if err := cmd.mutate(ctx, id, s, b, nil); err != nil {
